...
public class Snake extends ApplicationAdapter {
    ...
    private Sound slam;
    private final int WIDTH_TILES = 25;
    private final int HEIGHT_TILES = 19;
    ...
    public void create () {
        ...
        crunch = Gdx.audio.newSound(Gdx.files.internal("drop.wav"));
        slam = Gdx.audio.newSound(Gdx.files.internal("slam.wav"));
        headImg = new Texture("square.png");
        bodyImg = new Texture("square.png");
        appleImg = new Texture("square.png");
    ...
    public void render () {
        ...
        myBitMapFont.draw(batch, scoreName, 20, 580);
        myBitMapFont.draw(batch, "speed: " + SPEED, 20, 560);
        batch.end();
        //BATCH
